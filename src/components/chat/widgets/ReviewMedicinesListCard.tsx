...
export function ReviewMedicinesListCard({
  ...
  const isAddNewChosen = readOnly && (
    parsed?.addNew === true ||
    (chosenLabel && String(chosenLabel).toLowerCase().includes("add"))
  );
  const isSkipAllChosen = readOnly && (
    parsed?.skipAll === true ||
  ...
  return (
    ...
    >
      ...
      >
          ...
          style={[
            styles.bigActionButtonSide,
            {
              backgroundColor: readOnly
                ? (isConfirmChosen ? theme.colors.primary : (isDark ? "#334155" : "#e2e8f0"))
                : theme.colors.primary,
              flex: 1,
              marginRight: 6,
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
            {isAddNewChosen && <Ionicons name="checkmark" size={16} color={theme.colors.textPrimary} style={{ marginRight: 4 }} />}
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
          {isSkipAllChosen && <Ionicons name="checkmark" size={14} color={theme.colors.textSecondary} style={{ marginRight: 4 }} />}
