export const I18N_ONBOARDING_UI: Record<string, Record<string, string>> = {
  english: {
    ...
    "hcWizard.title": "Connect Health Connect",
    "hcWizard.stepCompatibilityTitle": "Device Compatibility",
    "hcWizard.stepCompatibilitySub": "Checking Android version and Health Connect support",
    "hcWizard.stepAvailabilityTitle": "Health Connect Status",
    "hcWizard.stepAvailabilitySub": "Verify if Health Connect is installed on your device",
    "hcWizard.stepCorePermissionsTitle": "Core Permissions",
    "hcWizard.stepCorePermissionsSub": "Allow reading steps, heart rate, sleep, and active energy",
    "hcWizard.stepAdvancedPermissionsTitle": "Advanced Health Metrics",
    "hcWizard.stepAdvancedPermissionsSub": "Allow reading SpO2, blood pressure, glucose, and temperature",
    "hcWizard.stepDataSourcesTitle": "Data Sources & Apps",
    "hcWizard.stepDataSourcesSub": "Detecting connected apps (Samsung Health, NoiseFit, Fitbit, etc.)",
    "hcWizard.stepSummaryTitle": "Connection Summary",
    "hcWizard.stepSummarySub": "Overview of synced data and status",
    "hcWizard.stepPermissionDetailsTitle": "Permission Breakdown",
    "hcWizard.stepPermissionDetailsSub": "Itemized status of all 14 Health Connect permissions",
    "hcWizard.stepHelpTitle": "Troubleshooting & Guidance",
    "hcWizard.stepHelpSub": "OEM companion app setup instructions (NoiseFit, boAt, etc.)",
    "hcWizard.stepFinalTitle": "Setup Complete",
    "hcWizard.stepFinalSub": "Health Connect is configured and ready",
    "hcWizard.btnNext": "Next",
    "hcWizard.btnBack": "Back",
    "hcWizard.btnGrant": "Grant Permissions",
    "hcWizard.btnInstall": "Install Health Connect",
    "hcWizard.btnOpenSettings": "Open Settings",
    "hcWizard.btnSyncNow": "Sync Now",
    "hcWizard.btnFinish": "Go to Dashboard",
    "hcWizard.btnSkip": "Skip for now",
    "hcWizard.btnRetry": "Retry Check",
    "hcWizard.statusNotGranted": "Not Granted",
    "hcWizard.statusGranted": "Granted",
    "hcWizard.statusConnected": "Connected",
    "hcWizard.statusDisconnected": "Disconnected",
    "hcWizard.statusAllowed": "Allowed",
    "hcWizard.statusNotAllowed": "Not Allowed",
    "hcWizard.statusPending": "Checking...",
    "hcWizard.statusAvailable": "Available",
    "hcWizard.statusUnavailable": "Unavailable",
    "hcWizard.statusInstalled": "Installed",
    "hcWizard.statusNotInstalled": "Not Installed",
  },
  gujarati: {
    ...
    "hcWizard.title": "હેલ્થ કનેક્ટ કનેક્ટ કરો",
    "hcWizard.stepCompatibilityTitle": "ડિવાઇસ સુસંગતતા",
    "hcWizard.stepCompatibilitySub": "એન્ડ્રોઇડ વર્ઝન અને હેલ્થ કનેક્ટ સપોર્ટ તપાસી રહ્યા છીએ",
    "hcWizard.stepAvailabilityTitle": "હેલ્થ કનેક્ટ સ્થિતિ",
    "hcWizard.stepAvailabilitySub": "તમારા ઉપકરણ પર હેલ્થ કનેક્ટ ઇન્સ્ટોલ કરેલું છે કે નહીં તે ચકાસો",
    "hcWizard.stepCorePermissionsTitle": "મુખ્ય પરવાનગીઓ",
    "hcWizard.stepCorePermissionsSub": "પગલાં, હૃદયના ધબકારા, ઊંઘ અને શક્તિ વાચવાની મંજૂરી આપો",
    "hcWizard.stepAdvancedPermissionsTitle": "અદ્યતન આરોગ્ય મેટ્રિક્સ",
    "hcWizard.stepAdvancedPermissionsSub": "SpO2, બ્લડ પ્રેશર, ગ્લુકોઝ અને તાપમાનની પરવાનગી આપો",
    "hcWizard.stepDataSourcesTitle": "ડેટા સ્ત્રોતો અને એપ્સ",
    "hcWizard.stepDataSourcesSub": "કનેક્ટેડ એપ્સ શોધી રહ્યા છીએ (સેમસંગ હેલ્થ, નોઇઝફિટ, વગેરે)",
    "hcWizard.stepSummaryTitle": "કનેક્શન સારાંશ",
    "hcWizard.stepSummarySub": "સિંક થયેલ ડેટા અને સ્થિતિની વિહંગાવલોકન",
    "hcWizard.stepPermissionDetailsTitle": "પરવાનગીઓની વિગત",
    "hcWizard.stepPermissionDetailsSub": "તમામ ૧૪ હેલ્થ કનેક્ટ પરવાનગીઓની વિગતવાર સ્થિતિ",
    "hcWizard.stepHelpTitle": "સમસ્યા નિવારણ અને માર્ગદર્શન",
    "hcWizard.stepHelpSub": "ઓઈએમ એપ્લિકેશન સેટઅપ સૂચનાઓ (નોઇઝફિટ, બોટ, વગેરે)",
    "hcWizard.stepFinalTitle": "સેટઅપ પૂર્ણ થયું",
    "hcWizard.stepFinalSub": "હેલ્થ કનેક્ટ કન્ફિગર થઈ ગયું છે",
    "hcWizard.btnNext": "આગળ",
    "hcWizard.btnBack": "પાછળ",
    "hcWizard.btnGrant": "પરવાનગી આપો",
    "hcWizard.btnInstall": "ઇન્સ્ટોલ કરો",
    "hcWizard.btnOpenSettings": "સેટિંગ્સ ખોલો",
    "hcWizard.btnSyncNow": "હમણાં સિંક કરો",
    "hcWizard.btnFinish": "ડેશબોર્ડ પર જાઓ",
    "hcWizard.btnSkip": "હમણાં છોડી દો",
    "hcWizard.btnRetry": "ફરી પ્રયાસ કરો",
    "hcWizard.statusNotGranted": "મંજૂર નથી",
    "hcWizard.statusGranted": "મંજૂર કરેલ",
    "hcWizard.statusConnected": "કનેક્ટેડ",
    "hcWizard.statusDisconnected": "ડિસ્કનેક્ટેડ",
    "hcWizard.statusAllowed": "માન્ય",
    "hcWizard.statusNotAllowed": "અમાન્ય",
    "hcWizard.statusPending": "તપાસી રહ્યા છીએ...",
    "hcWizard.statusAvailable": "ઉપલબ્ધ",
    "hcWizard.statusUnavailable": "અનુપલબ્ધ",
    "hcWizard.statusInstalled": "ઇન્સ્ટોલ કરેલું",
    "hcWizard.statusNotInstalled": "ઇન્સ્ટોલ નથી",
  },
  hindi: {
    ...
    "hcWizard.title": "हेल्थ कनेक्ट कनेक्ट करें",
    "hcWizard.stepCompatibilityTitle": "डिवाइस संगतता",
    "hcWizard.stepCompatibilitySub": "एंड्रॉइड संस्करण और हेल्थ कनेक्ट समर्थन की जांच कर रहे हैं",
    "hcWizard.stepAvailabilityTitle": "हेल्थ कनेक्ट स्थिति",
    "hcWizard.stepAvailabilitySub": "जांचें कि आपके डिवाइस पर हेल्थ कनेक्ट इंस्टॉल है या नहीं",
    "hcWizard.stepCorePermissionsTitle": "मुख्य अनुमतियां",
    "hcWizard.stepCorePermissionsSub": "कदम, हृदय गति, नींद और सक्रिय ऊर्जा पढ़ने की अनुमति दें",
    "hcWizard.stepAdvancedPermissionsTitle": "उन्नत स्वास्थ्य मीट्रिक",
    "hcWizard.stepAdvancedPermissionsSub": "SpO2, रक्तचाप, ग्लूकोज और तापमान पढ़ने की अनुमति दें",
    "hcWizard.stepDataSourcesTitle": "डेटा स्रोत और ऐप्स",
    "hcWizard.stepDataSourcesSub": "जुड़े ऐप्स का पता लगा रहे हैं (सैमसंग हेल्थ, नॉइज़फ़िट, आदि)",
    "hcWizard.stepSummaryTitle": "कनेक्शन सारांश",
    "hcWizard.stepSummarySub": "सिंक किए गए डेटा और स्थिति का अवलोकन",
    "hcWizard.stepPermissionDetailsTitle": "अनुमति विवरण",
    "hcWizard.stepPermissionDetailsSub": "सभी 14 हेल्थ कनेक्ट अनुमतियों की विस्तृत स्थिति",
    "hcWizard.stepHelpTitle": "समस्या निवारण और मार्गदर्शन",
    "hcWizard.stepHelpSub": "OEM साथी ऐप सेटअप निर्देश (नॉइज़फ़िट, बोट, आदि)",
    "hcWizard.stepFinalTitle": "सेटअप पूर्ण हुआ",
    "hcWizard.stepFinalSub": "हेल्थ कनेक्ट कॉन्फ़िगर हो गया है",
    "hcWizard.btnNext": "आगे",
    "hcWizard.btnBack": "पीछे",
    "hcWizard.btnGrant": "अनुमति दें",
    "hcWizard.btnInstall": "हेल्थ कनेक्ट इंस्टॉल करें",
    "hcWizard.btnOpenSettings": "सेटिंग्स खोलें",
    "hcWizard.btnSyncNow": "अभी सिंक करें",
    "hcWizard.btnFinish": "डैशबोर्ड पर जाएं",
    "hcWizard.btnSkip": "अभी छोड़ें",
    "hcWizard.btnRetry": "पुनः प्रयास करें",
    "hcWizard.statusNotGranted": "अनुमति नहीं दी गई",
    "hcWizard.statusGranted": "अनुमति दी गई",
    "hcWizard.statusConnected": "कनेक्टेड",
    "hcWizard.statusDisconnected": "डिसकनेक्टेड",
    "hcWizard.statusAllowed": "अनुमत",
    "hcWizard.statusNotAllowed": "अननुमत",
    "hcWizard.statusPending": "जांच कर रहे हैं...",
    "hcWizard.statusAvailable": "उपलब्ध",
    "hcWizard.statusUnavailable": "अनुपलब्ध",
    "hcWizard.statusInstalled": "इंस्टॉल किया गया",
    "hcWizard.statusNotInstalled": "इंस्टॉल नहीं है",
  },
  marathi: {
    ...
    "hcWizard.title": "હેલ્થ કનેક્ટ કનેક્ટ કરો",
    "hcWizard.stepCompatibilityTitle": "ડિવાઇસ સુસંગતતા",
    "hcWizard.stepCompatibilitySub": "અँડ્રોઇડ व्हર્જન અને હેલ્થ કનેક્ટ સપોર્ટ તપાસત આહોત",
    "hcWizard.stepAvailabilityTitle": "હેલ્થ કનેક્ટ સ્થિતિ",
    "hcWizard.stepAvailabilitySub": "આપલ્યા ડિવ્હાઇસવર હેલ્થ કનેક્ટ ઇન્સ્ટોલ આહે કા તે તપાસા",
    "hcWizard.stepCorePermissionsTitle": "મુખ્ય પરવાનગ્યા",
    "hcWizard.stepCorePermissionsSub": "પાવલે, હૃદયાચે ઠોકે, ઝોપ અને સક્રિય ઊર્જા વાચણ્યાચી પરવાનગી દ્યા",
    "hcWizard.stepAdvancedPermissionsTitle": "પ્રગત આરોગ્ય મેટ્રિક્સ",
    "hcWizard.stepAdvancedPermissionsSub": "SpO2, રક્તદાબ, ગ્લુકોઝ અને તાપમાન વાચણ્યાચી પરવાનગી દ્યા",
    "hcWizard.stepDataSourcesTitle": "ડેટા સ્રોત અને ॲપ્સ",
    "hcWizard.stepDataSourcesSub": "કનેક્ટ કેલેલે ॲપ્સ શોધત આહોત (સૅમસંગ હેલ્થ, નોઈઝફિટ, ઇત્યાદી)",
    "hcWizard.stepSummaryTitle": "કનેક્શન સારાંશ",
    "hcWizard.stepSummarySub": "સિંક કેલેલા ડેટા અને સ્થિતિચે પુનરાવલોકન",
    "hcWizard.stepPermissionDetailsTitle": "પરવાનગી તપશીલ",
    "hcWizard.stepPermissionDetailsSub": "સર્વ ૧૪ હેલ્થ કનેક્ટ પરવાનગ્યાંચી સવિસ્તર સ્થિતિ",
    "hcWizard.stepHelpTitle": "સમસ્યા નિવારણ અને માર્ગદર્શન",
    "hcWizard.stepHelpSub": "OEM ॲપ સેટઅપ સૂચના (નોઈઝફિટ, બોટ, ઇત્યાદી)",
    "hcWizard.stepFinalTitle": "સેટઅપ પૂર્ણ ઝાલા",
    "hcWizard.stepFinalSub": "હેલ્થ કનેક્ટ કોન્ફિગર ઝાલે આહે",
    "hcWizard.btnNext": "પુઢે",
    "hcWizard.btnBack": "માગે",
    "hcWizard.btnGrant": "પરવાનગી દ્યા",
    "hcWizard.btnInstall": "હેલ્થ કનેક્ટ ઇન્સ્ટોલ કરા",
    "hcWizard.btnOpenSettings": "સેટિંગ્ઝ ઉઘડા",
    "hcWizard.btnSyncNow": "આતા સિંક કરા",
    "hcWizard.btnFinish": "ડૅશબોર્ડવર જા",
    "hcWizard.btnSkip": "આત્તા વગળા",
    "hcWizard.btnRetry": "પુન્હા પ્રયત્ન કરા",
    "hcWizard.statusNotGranted": "પરવાનગી દિલી નાહી",
    "hcWizard.statusGranted": "પરવાનગી દિલી",
    "hcWizard.statusConnected": "કનેક્ટ કેલે",
    "hcWizard.statusDisconnected": "ડિસકનેક્ટ કેલે",
    "hcWizard.statusAllowed": "અનુમતી આહે",
    "hcWizard.statusNotAllowed": "અનુમતી નાહી",
    "hcWizard.statusPending": "તપાસત આહોત...",
    "hcWizard.statusAvailable": "ઉપલબ્ધ",
    "hcWizard.statusUnavailable": "અનુપલબ્ધ",
    "hcWizard.statusInstalled": "ઇન્સ્ટોલ કેલે આહે",
    "hcWizard.statusNotInstalled": "ઇન્સ્ટોલ કેલેલે નાહી",
  },
  tamil: {
    ...
    "hcWizard.title": "ஹெல்த் கனெக்ட் இணைக்கவும்",
    "hcWizard.stepCompatibilityTitle": "சாதன இணக்கத்தன்மை",
    "hcWizard.stepCompatibilitySub": "ஆண்ட்ராய்டு பதிப்பு மற்றும் ஹெல்த் கனெக்ட் ஆதரவைச் சரிபார்க்கிறது",
    "hcWizard.stepAvailabilityTitle": "ஹெல்த் கனெக்ட் நிலை",
    "hcWizard.stepAvailabilitySub": "உங்கள் சாதனத்தில் ஹெல்த் கனெக்ட் நிறுவப்பட்டுள்ளதா எனச் சரிபார்க்கவும்",
    "hcWizard.stepCorePermissionsTitle": "முக்கிய அனுமதிகள்",
    "hcWizard.stepCorePermissionsSub": "படிகள், இதயத் துடிப்பு, தூக்கம் மற்றும் ஆற்றலைப் படிக்க அனுமதிக்கவும்",
    "hcWizard.stepAdvancedPermissionsTitle": "மேம்பட்ட சுகாதார அளவீடுகள்",
    "hcWizard.stepAdvancedPermissionsSub": "SpO2, இரத்த அழுத்தம், குளுக்கோஸ் மற்றும் வெப்பநிலையைப் படிக்க அனுமதிக்கவும்",
    "hcWizard.stepDataSourcesTitle": "தரவு மூலங்கள் & பயன்பாடுகள்",
    "hcWizard.stepDataSourcesSub": "இணைக்கப்பட்ட பயன்பாடுகளைக் கண்டறிகிறது (சாம்சங் ஹெல்த், நாய்ஸ்ஃபிட் போன்றவை)",
    "hcWizard.stepSummaryTitle": "இணைப்பு சுருக்கம்",
    "hcWizard.stepSummarySub": "ஒத்திசைக்கப்பட்ட தரவு மற்றும் நிலையின் கண்ணோட்டம்",
    "hcWizard.stepPermissionDetailsTitle": "அனுமதி விவரங்கள்",
    "hcWizard.stepPermissionDetailsSub": "அனைத்து 14 ஹெல்த் கனெக்ட் அனுமதிகளின் நிலை விவரம்",
    "hcWizard.stepHelpTitle": "சிக்கல் தீர்க்கும் வழிகாட்டுதல்",
    "hcWizard.stepHelpSub": "OEM பயன்பாட்டு அமைவு வழிகாட்டுதல் (நாய்ஸ்ஃபிட், போட் போன்றவை)",
    "hcWizard.stepFinalTitle": "அமைப்பு முடிந்தது",
    "hcWizard.stepFinalSub": "ஹெல்த் கனெக்ட் கட்டமைக்கப்பட்டு தயாராக உள்ளது",
    "hcWizard.btnNext": "அடுத்து",
    "hcWizard.btnBack": "பின்னால்",
    "hcWizard.btnGrant": "அனுமதி வழங்கு",
    "hcWizard.btnInstall": "ஹெல்த் கனெக்ட் நிறுவு",
    "hcWizard.btnOpenSettings": "அமைப்புகளைத் திற",
    "hcWizard.btnSyncNow": "இப்போது ஒத்திசை",
    "hcWizard.btnFinish": "டாஷ்போர்டிற்குச் செல்",
    "hcWizard.btnSkip": "இப்போது தவிர்",
    "hcWizard.btnRetry": "மீண்டும் முயற்சி செய்",
    "hcWizard.statusNotGranted": "அனுமதிக்கப்படவில்லை",
    "hcWizard.statusGranted": "அனுமதிக்கப்பட்டது",
    "hcWizard.statusConnected": "இணைக்கப்பட்டது",
    "hcWizard.statusDisconnected": "துண்டிக்கப்பட்டது",
    "hcWizard.statusAllowed": "அனுமதிக்கப்பட்டது",
    "hcWizard.statusNotAllowed": "அனுமதிக்கப்படவில்லை",
    "hcWizard.statusPending": "சரிபார்க்கிறது...",
    "hcWizard.statusAvailable": "கிடைக்கிறது",
    "hcWizard.statusUnavailable": "கிடைக்கவில்லை",
    "hcWizard.statusInstalled": "நிறுவப்பட்டது",
    "hcWizard.statusNotInstalled": "நிறுவப்படவில்லை",
  }
};
