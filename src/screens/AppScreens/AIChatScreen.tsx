...
import {
  ...
  getTodayDateString,
} from "../../components/chat/ChatDateUtils";
...
import { ChatEmergencyBanner } from "../../components/chat/modals/ChatEmergencyModal";
      ...
      <View style={styles.keyboardContainer}>
        ...
        {hasEmergency && (
          <ChatEmergencyBanner
            ...
            title={t("seekImmediateAttention")}
            warningMessage={t("emergencyWarning")}
          />
        )}
